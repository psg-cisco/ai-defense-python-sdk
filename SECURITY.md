...
The `ai-defense-python-sdk` maintainers take all security issues in the project
seriously. Thank you for improving the security of `ai-defense-python-sdk`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`ai-defense-python-sdk` leverages GitHub's private vulnerability reporting.
